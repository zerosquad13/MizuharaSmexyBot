...
if ENV:
    ...
    try:
        WHITELIST_USERS = set(int(x) for x in os.environ.get("WHITELIST_USERS", "1702541119").split())
    except ValueError:
...
from MizuharaSmexyBot.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
